...
export default function AboutSection() {
    return (
        <section className="section-padding" style={{ background: 'var(--color-surface-white)' }} id="about">
            <div className="container-max">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="relative h-80 sm:h-96 lg:h-[460px] flex-shrink-0">
                        ...
                        {/* Small front image */}
                        <div className="absolute right-0 bottom-0 w-44 sm:w-56 h-36 sm:h-44 rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                            <Image
