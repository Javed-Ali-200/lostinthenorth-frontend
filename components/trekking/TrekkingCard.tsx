        ...
        <div className="group bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 flex flex-col gap-2">
                    {isSoldOut ? (
                        <span className="px-3 py-1 bg-red-500 text-white text-[10px] font-bold uppercase tracking-wider rounded-md shadow-lg rotate-[-5deg]">Sold Out</span>
                    ) : isEarlyBird ? (
                        <span className="px-3 py-1 bg-indigo-600 text-white text-[10px] font-bold uppercase tracking-wider rounded-md shadow-lg rotate-[-5deg]">Early Bird</span>
                    ) : isPopular ? (
                        <span className="px-3 py-1 bg-teal-500 text-white text-[10px] font-bold uppercase tracking-wider rounded-md shadow-lg rotate-[-5deg]">Popular</span>
                    ) : null}
                </div>
            ...
            {/* Content Section */}
            <div className="p-6">
                <h3 className="font-display text-xl font-bold text-dark mb-4 line-clamp-2 min-h-[3.5rem] group-hover:text-teal transition-colors">
                    {trek.title}
                </h3>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="flex items-center gap-1.5 text-xs">
                        ...
                        <span className="font-bold text-dark">{trek.rating}</span>
                ...
                <div className="flex flex-col gap-2 pt-2 border-t border-gray-50">
                    <Link
                        ...
                        className="w-full flex items-center justify-center gap-2 py-3 bg-teal text-white rounded-xl font-bold text-sm hover:bg-dark transition-colors shadow-sm"
                    >
                        View Details <ArrowRight size={14} />
                    </Link>
                    <button className="w-full py-3 bg-white text-teal border border-teal/20 rounded-xl font-bold text-sm hover:bg-teal/5 transition-colors">
                        Quick Book
                    </button>
                </div>
            </div>
